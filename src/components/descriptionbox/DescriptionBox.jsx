  ...
  return (
    <div className={styles.descriptionbox}>
      <div className={styles.descriptionbox_navigator}>
        <div
          onClick={() => setSelectInfo("description")}
          style={
            selectInfo === "description"
              ? { background: "#ff4141", color: "white" }
              : {}
          }
          className={styles.descriptionbox_nav_box}
        >
          Description
        </div>
        <div
        ...
        {selectInfo === "description" ? (
          <>
            ...
            <p>
              ...
              <p>
                <span> Shipping:</span> {productDetails.shippingInformation}
              </p>
              <p>
                <span> Return:</span> {productDetails.returnPolicy}
              </p>
              <p>
                <span>Warrenty: </span>
          ...
          <>
            {productDetails.reviews.map((review, index) => (
              <p key={index}>
                ...
                <p>
                  <span>Rating (0-5) :</span> {review.rating}
                </p>
                <p>
                  <span>Date :</span>{" "}
